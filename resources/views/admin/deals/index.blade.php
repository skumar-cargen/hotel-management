<x-admin-layout title="Deals" pageTitle="Deals">
    <x-slot:breadcrumb>
    ...
    <div class="page-header">
        ...
        <div class="flex-grow-1">
            <h4>Deals</h4>
            <p>Manage customer-facing deals and discount offers</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('admin.deals.create') }}" class="btn btn-light px-4">
                <i class='bx bx-plus me-1'></i> Add Deal
            </a>
        </div>
    </div>
