<x-admin-layout title="Customers" pageTitle="Customers">
    <x-slot:breadcrumb>
    ...
    <div class="page-header">
        <div class="header-icon" style="background: linear-gradient(135deg, #06b6d4, #22d3ee);">
        ...
        $(document).ready(function() {
            $('#data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'auth_type', name: 'auth_type', orderable: false, searchable: false },
                    { data: 'bookings_count_display', name: 'bookings_count', orderable: false, searchable: false },
