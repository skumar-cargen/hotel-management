<x-admin-layout title="Amenities" pageTitle="Amenities">
    <x-slot:breadcrumb>
    ...
    <div class="page-header">
        ...
        <div class="flex-grow-1">
            <h4>Amenities</h4>
            <p>Manage hotel amenities and facilities</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('admin.amenities.create') }}" class="btn btn-light px-4">
