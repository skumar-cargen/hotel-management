<x-admin-layout title="Blog Categories" pageTitle="Blog Categories">
    <x-slot:breadcrumb>
    ...
    <div class="page-header">
        ...
        <div class="flex-grow-1">
            ...
            <p>Manage categories for blog posts</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('admin.blog-categories.create') }}" class="btn btn-light px-4">
        ...
        $(document).ready(function() {
            $('#data-table').DataTable({
                ...
                columns: [
                    { data: 'name', name: 'name' },
                    { data: 'slug', name: 'slug' },
                    { data: 'posts_count_label', name: 'posts_count', orderable: true, searchable: false },
