<x-admin-layout title="Room Types - {{ $hotel->name }}" pageTitle="Room Types">
    <x-slot:breadcrumb>
    ...
    <div class="page-header">
        ...
        <div class="header-actions">
            <a href="{{ route('admin.hotels.room-types.create', $hotel) }}" class="btn btn-light px-4">
    ...
    <x-slot:scripts>
        ...
        $(document).ready(function() {
            $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("admin.hotels.room-types.index", $hotel) }}',
                columns: [
                    { data: 'name', name: 'name' },
