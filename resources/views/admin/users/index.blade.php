<x-admin-layout title="Users" pageTitle="Users">
    <x-slot:breadcrumb>
    ...
    <div class="page-header">
        <div class="header-icon" style="background: linear-gradient(135deg, #ec4899, #f472b6);">
            <i class='bx bx-group'></i>
        </div>
        <div class="flex-grow-1">
            <h4>Users</h4>
            <p>Manage admin users, roles, and domain access</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('admin.users.create') }}" class="btn btn-light px-4">
        ...
        $(document).ready(function() {
            $('#data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'role', name: 'role' },
                    { data: 'managed_domains', name: 'managed_domains', orderable: false, searchable: false },
