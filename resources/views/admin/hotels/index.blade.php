<x-admin-layout title="Hotels" pageTitle="Hotels">
    <x-slot:breadcrumb>
    ...
    <div class="page-header">
        ...
        <div class="flex-grow-1">
            <h4>Hotels</h4>
            <p>Manage your hotel listings and property details</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('admin.hotels.create') }}" class="btn btn-light px-4">
        ...
        $(document).ready(function() {
            $('#data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'stars', name: 'star_rating', searchable: false },
