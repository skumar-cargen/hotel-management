<x-admin-layout title="Locations" pageTitle="Locations">
    <x-slot:breadcrumb>
    ...
    <div class="page-header">
        ...
        <div class="flex-grow-1">
            <h4>Locations</h4>
            <p>Manage areas, districts, and cities for your listings</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('admin.locations.create') }}" class="btn btn-light px-4">
