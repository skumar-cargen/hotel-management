<x-admin-layout title="Careers" pageTitle="Careers">
    <x-slot:breadcrumb>
    ...
    <div class="page-header">
        ...
        <div class="header-actions">
            <a href="{{ route('admin.careers.create') }}" class="btn btn-light px-4">
                <i class='bx bx-plus me-1'></i> Add Career
            </a>
        </div>
    </div>
        ...
        $(document).ready(function() {
            $('#data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'job_type_label', name: 'job_type', orderable: true, searchable: false },
                    { data: 'domain_list', name: 'domain_list', orderable: false, searchable: false },
                    { data: 'last_date', name: 'last_apply_date', searchable: false },
