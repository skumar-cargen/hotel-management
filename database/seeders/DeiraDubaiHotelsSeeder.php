...
class DeiraDubaiHotelsSeeder extends Seeder
{
    private int $counter = 1000;

    public function run(): void
    {
        $this->command->info('Seeding Deira Dubai Hotels domain...');
        ...
        $this->command->info('Deira Dubai Hotels seeded successfully!');
    }
    ...
    private function seedDomain(): Domain
    {
        $domain = Domain::updateOrCreate(
            ['slug' => 'deira-dubai-hotels'],
            [
                'name' => 'Deira Dubai Hotels',
                'domain' => 'deiradubaihotels.com',
                'is_active' => true,
                'is_primary' => false,
                'default_currency' => 'AED',
                'default_language' => 'en',
                'meta_title' => 'Deira Dubai Hotels — Hotels in Deira, Dubai\'s Historic Trading Hub',
                'meta_description' => 'Book hotels in Deira, Dubai. Stay near the Gold Souk, Spice Souk, and Dubai Creek. From heritage five-star hotels to affordable city stays.',
                'meta_keywords' => 'deira hotels, gold souk hotels, dubai creek hotels, al rigga hotels, naif hotels, port saeed hotels, old dubai hotels',
                'phone' => '+971 4 227 5500',
                'email' => 'info@deiradubaihotels.com',
    ...
    private function seedHeroSlides(Domain $domain): void
    {
        ...
        $slides = [
            [
                'title' => 'Discover',
                'highlight' => 'Historic Deira',
                'subtitle' => 'Gold Souk, Spice Souk & the soul of old Dubai',
                'description' => 'Stay in the heart of Dubai\'s legendary trading district.',
                'keywords' => 'dubai,souk,gold,heritage',
            ],
            [
                'title' => 'Experience',
                'highlight' => 'Creek-Side Luxury',
                'subtitle' => 'Five-star hotels overlooking the iconic Dubai Creek',
                'description' => 'Where traditional dhows and modern luxury meet.',
                'keywords' => 'dubai,creek,boat,sunset',
            ],
            [
                'title' => 'Explore',
                'highlight' => 'Al Rigga\'s Energy',
                'subtitle' => 'Vibrant nightlife, diverse dining, and city buzz',
                'description' => 'Deira\'s most dynamic neighbourhood at your doorstep.',
                'keywords' => 'dubai,city,night,street',
            ],
            [
                'title' => 'Tradition Meets',
                'highlight' => 'Modern Comfort',
                'subtitle' => 'Heritage landmarks with world-class hotel amenities',
                'description' => 'The best of old and new Dubai in one stay.',
                'keywords' => 'hotel,modern,elegant,lobby',
            ],
        ];
    ...
    private function seedContentPages(Domain $domain): void
    {
        ...
        $domain->update([
            ...
            'about_us_meta_description' => "Learn about {$brandName} — your gateway to hotels in Deira, Dubai's historic trading district. Discover the Gold Souk, Creek heritage, and authentic Dubai culture.",
    ...
    private function generateLogoPng(string $path, string $brandName): void
    {
        ...
        // Deep gold brand color
        $iconColor = imagecolorallocate($img, 180, 150, 50);
        $iconSize = 50;
        ...
        imagestring($img, 5, 75, 42, 'Deira Dubai', $textColor);
...
<p>At <strong>{$brandName}</strong>, we specialise in connecting travellers with the finest hotels in Deira — Dubai's historic trading heart. From the glittering Gold Souk and aromatic Spice Souk to the timeless beauty of Dubai Creek, we curate a collection of hotels that celebrate the soul of old Dubai while delivering modern comfort.</p>

<h3>Our Mission</h3>
<p>Our mission is to make discovering and booking hotels in Deira effortless and inspiring. We handpick every property to ensure it meets the highest standards of quality, location, and guest experience — whether you seek a heritage five-star on the Creek or an affordable city stay on Al Rigga Road.</p>

<h3>What Sets Us Apart</h3>
<ul>
    <li><strong>Deira Specialists</strong> — We know every souk, every Creek-side promenade, and every hidden gem in Dubai's oldest commercial district.</li>
    ...
    <li><strong>Local Expertise</strong> — Our Dubai-based team provides insider knowledge on heritage landmarks, authentic dining, and cultural experiences.</li>
    <li><strong>24/7 Concierge</strong> — From airport transfers to abra boat tours, our dedicated team is available around the clock.</li>
    <li><strong>Flexible Booking</strong> — Free cancellation on most properties up to 48 hours before check-in.</li>
</ul>

<h3>Our Story</h3>
<p>Born from a passion for Dubai's rich trading heritage, {$brandName} was founded by a team of hospitality professionals who believe that Deira offers the most authentic Dubai experience. While the city's skyline reaches ever higher, Deira's souks, Creek dhows, and multicultural streets preserve the spirit that made Dubai great.</p>
<p>Today we serve thousands of guests each year, helping them discover the perfect Deira stay — whether it's a Creek-view suite at a heritage five-star, a vibrant hotel on Al Rigga Road, or a budget-friendly base near the Gold Souk.</p>
...
<ul>
    ...
    <li><strong>Cultural Respect</strong> — We celebrate Deira's multicultural heritage and promote respectful, immersive travel.</li>
</ul>

<p>Thank you for choosing <strong>{$brandName}</strong>. Your authentic Dubai adventure awaits.</p>
HTML;
    }
...
<strong>Phone:</strong> +971 4 227 5500<br>
<strong>Address:</strong> Al Rigga Road, Deira, Dubai, UAE</p>
HTML;
    }
