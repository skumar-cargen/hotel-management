...
class AlBarshaHotelsSeeder extends Seeder
{
    private int $counter = 200;

    public function run(): void
    {
        $this->command->info('Seeding Al Barsha Hotels domain...');
        ...
        $this->command->info('Al Barsha Hotels seeded successfully!');
    }
    ...
    private function seedDomain(): Domain
    {
        $domain = Domain::updateOrCreate(
            ['slug' => 'al-barsha-hotels'],
            [
                'name' => 'Al Barsha Hotels',
                'domain' => 'thealbarshahotels.com',
                'is_active' => true,
                'is_primary' => false,
                'default_currency' => 'AED',
                'default_language' => 'en',
                'meta_title' => 'Al Barsha Hotels — Premium Hotels in Al Barsha, Dubai',
                'meta_description' => 'Discover and book premium hotels in Al Barsha, Dubai. Convenient access to Mall of the Emirates, Dubai Metro, and the city\'s top attractions.',
                'meta_keywords' => 'al barsha hotels, dubai hotels, mall of the emirates hotels, barsha heights hotels, tecom hotels, dubai accommodation, al barsha dubai',
                'phone' => '+971 4 444 7722',
                'email' => 'info@thealbarshahotels.com',
    ...
    private function seedHeroSlides(Domain $domain): void
    {
        ...
        $slides = [
            [
                'title' => 'Discover',
                'highlight' => 'Al Barsha\'s Finest Hotels',
                'subtitle' => 'Premium stays in Dubai\'s most connected neighbourhood',
                'description' => 'Book handpicked hotels in Al Barsha — steps from Mall of the Emirates and Dubai Metro.',
                'keywords' => 'dubai,hotel,modern,city',
            ],
            [
                'title' => 'Experience',
                'highlight' => 'Urban Desert Elegance',
                'subtitle' => 'Where convenience meets comfort in the heart of New Dubai',
                'description' => 'Contemporary hotels with easy access to Dubai\'s top attractions and business districts.',
                'keywords' => 'luxury,hotel,lobby,modern',
            ],
            [
                'title' => 'Stay Near',
                'highlight' => 'Mall of the Emirates',
                'subtitle' => 'World-class shopping, Ski Dubai, and dining at your doorstep',
                'description' => 'Hotels within walking distance of one of Dubai\'s most iconic shopping destinations.',
                'keywords' => 'dubai,shopping,mall,luxury',
            ],
            [
                'title' => 'Your Gateway To',
                'highlight' => 'Dubai Adventures',
                'subtitle' => 'Central location with Metro access to every corner of the city',
                'description' => 'Strategically located hotels perfect for business and leisure travellers alike.',
                'keywords' => 'dubai,skyline,sunset,city',
            ],
        ];
    ...
    private function seedContentPages(Domain $domain): void
    {
        ...
        $domain->update([
            ...
            'about_us_meta_description' => "Learn about {$brandName} — your guide to premium hotels in the Al Barsha district of Dubai. Discover our mission, values, and commitment to hospitality excellence.",
    ...
    private function generateLogoPng(string $path, string $brandName): void
    {
        ...
        // Teal brand color
        $iconColor = imagecolorallocate($img, 13, 148, 136);
        $iconSize = 50;
        imagefilledrectangle($img, 10, 35, 10 + $iconSize, 35 + $iconSize, $iconColor);

        $white = imagecolorallocate($img, 255, 255, 255);
        imagestring($img, 5, 22, 52, 'AB', $white);

        $textColor = imagecolorallocate($img, 30, 30, 50);
        imagestring($img, 5, 75, 42, 'Al Barsha', $textColor);
...
<p>At <strong>{$brandName}</strong>, we specialise in connecting travellers with the finest hotels in Dubai's vibrant Al Barsha district. From the bustling energy of Al Barsha 1 — home to Mall of the Emirates — to the business-friendly towers of Barsha Heights (TECOM) and the creative hub of Al Quoz, we curate a collection of hotels that combine convenience, comfort, and value.</p>

<h3>Our Mission</h3>
<p>Our mission is to make finding and booking the perfect hotel in Al Barsha effortless. We handpick every property to ensure it meets high standards of quality, location, and guest satisfaction — whether you're visiting for business, shopping, or leisure.</p>

<h3>What Sets Us Apart</h3>
<ul>
    <li><strong>Al Barsha Specialists</strong> — We know every street, every shortcut, and every hidden gem in the Al Barsha district. Our local expertise is unmatched.</li>
    ...
    <li><strong>Metro-Connected</strong> — Every hotel we feature is conveniently located near Dubai Metro stations for easy city-wide access.</li>
...
<h3>Our Story</h3>
<p>Al Barsha has evolved from a quiet residential area into one of Dubai's most dynamic districts. With Mall of the Emirates as its anchor, the neighbourhood now boasts world-class hotels, diverse dining, and excellent transport links. {$brandName} was founded to showcase the best of this transformation — helping travellers discover why Al Barsha is the smart choice for a Dubai stay.</p>
<p>Today we serve thousands of guests each year, from business travellers seeking proximity to Internet City and Media City, to families wanting easy access to Ski Dubai and the city's top attractions.</p>
...
<ul>
    ...
    <li><strong>Community</strong> — We support local businesses and promote the Al Barsha community.</li>
</ul>

<p>Thank you for choosing <strong>{$brandName}</strong>. Your perfect Al Barsha stay awaits.</p>
HTML;
    }
...
<strong>Phone:</strong> +971 4 444 7722<br>
<strong>Address:</strong> Al Barsha 1, Near Mall of the Emirates, Dubai, UAE</p>
HTML;
    }
