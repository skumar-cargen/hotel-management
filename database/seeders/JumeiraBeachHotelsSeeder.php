...
class JumeiraBeachHotelsSeeder extends Seeder
{
    private int $counter = 100;

    public function run(): void
    {
        $this->command->info('Seeding Jumeira Beach Hotels domain...');
        ...
        $this->command->info('Jumeira Beach Hotels seeded successfully!');
    }
    ...
    private function seedDomain(): Domain
    {
        $domain = Domain::updateOrCreate(
            ['slug' => 'jumeira-beach-hotels'],
            [
                'name' => 'Jumeira Beach Hotels',
                'domain' => 'jumeirabeachhotels.com',
                'is_active' => true,
                'is_primary' => false,
                'default_currency' => 'AED',
                'default_language' => 'en',
                'meta_title' => 'Jumeira Beach Hotels — Luxury Beachfront Hotels in Dubai',
                'meta_description' => 'Discover and book luxury beachfront hotels in Dubai. From Palm Jumeirah to JBR, experience five-star elegance with stunning Arabian Gulf views.',
                'meta_keywords' => 'jumeira beach hotels, dubai beach hotels, luxury hotels dubai, palm jumeirah hotels, jbr hotels, dubai marina hotels, beachfront hotel dubai',
                'phone' => '+971 4 555 8899',
                'email' => 'info@jumeirabeachhotels.com',
    ...
    private function seedHeroSlides(Domain $domain): void
    {
        ...
        $slides = [
            [
                'title' => 'Experience',
                'highlight' => 'Jumeira Beach Luxury',
                'subtitle' => 'Where golden sands meet world-class hospitality',
                'description' => 'Discover the finest beachfront hotels along Dubai\'s iconic Jumeira coastline.',
                'keywords' => 'dubai,beach,luxury,resort',
            ],
            [
                'title' => 'Discover',
                'highlight' => 'Beachfront Paradise',
                'subtitle' => 'Wake up to stunning Arabian Gulf views',
                'description' => 'Premium beachfront hotels with direct access to pristine sandy beaches.',
                'keywords' => 'arabian,gulf,beach,sunrise',
            ],
            [
                'title' => 'Indulge In',
                'highlight' => 'Five-Star Elegance',
                'subtitle' => 'Curated stays at Dubai\'s most prestigious addresses',
                'description' => 'Hand-selected luxury hotels offering the highest standards of service.',
                'keywords' => 'luxury,hotel,interior,elegant',
            ],
            [
                'title' => 'Your Gateway To',
                'highlight' => 'Unforgettable Moments',
                'subtitle' => 'Private beaches, infinity pools & impeccable service',
                'description' => 'Create lasting memories at Dubai\'s most exclusive beachfront properties.',
                'keywords' => 'infinity,pool,beach,sunset',
            ],
        ];
    ...
    private function seedContentPages(Domain $domain): void
    {
        ...
        $domain->update([
            ...
            'about_us_meta_description' => "Learn about {$brandName} — your gateway to the finest beachfront hotels in Dubai. Discover our mission, values, and commitment to luxury hospitality.",
    ...
    private function generateLogoPng(string $path, string $brandName): void
    {
        ...
        // Warm gold brand color
        $iconColor = imagecolorallocate($img, 205, 160, 60);
        $iconSize = 50;
        ...
        imagestring($img, 5, 75, 42, 'Jumeira Beach', $textColor);
    ...
    private function generateFaviconPng(string $path, string $brandName): void
    {
        ...
        $bgColor = imagecolorallocate($img, 205, 160, 60);
        imagefilledrectangle($img, 4, 4, $size - 5, $size - 5, $bgColor);

        $white = imagecolorallocate($img, 255, 255, 255);
        $tw = imagefontwidth(5);
        $th = imagefontheight(5);
        imagestring($img, 5, ($size - $tw) / 2, ($size - $th) / 2, 'J', $white);
...
<p>At <strong>{$brandName}</strong>, we specialise in connecting travellers with the finest beachfront hotels along Dubai's iconic Jumeira coastline and beyond. From the golden sands of Palm Jumeirah to the vibrant energy of JBR and the sophisticated waterfront of Dubai Marina, we curate a collection of hotels that define luxury by the sea.</p>

<h3>Our Mission</h3>
<p>Our mission is to make booking a luxury beachfront hotel in Dubai effortless and inspiring. We handpick every property to ensure it meets the highest standards of quality, location, and guest experience — so you can focus on creating unforgettable memories.</p>

<h3>What Sets Us Apart</h3>
<ul>
    <li><strong>Beachfront Specialists</strong> — Every hotel in our collection offers direct beach access or stunning sea views. We know Dubai's coastline like no one else.</li>
    ...
    <li><strong>Local Expertise</strong> — Our Dubai-based team provides insider knowledge on the best neighbourhoods, hidden gems, and seasonal offers.</li>
    <li><strong>24/7 Concierge</strong> — From airport transfers to restaurant reservations, our dedicated team is available around the clock.</li>
    <li><strong>Flexible Booking</strong> — Free cancellation on most properties up to 48 hours before check-in.</li>
</ul>

<h3>Our Story</h3>
<p>Born from a love of Dubai's stunning coastline, {$brandName} was founded by a team of hospitality professionals and travel enthusiasts who saw an opportunity to create a curated platform focused exclusively on beachfront luxury. We believe that where you stay shapes your entire holiday — and a beachfront hotel in Dubai is an experience unlike any other.</p>
<p>Today we serve thousands of guests each year, helping them discover the perfect beachfront escape — whether it's a romantic getaway at a Palm Jumeirah resort, a family holiday at JBR, or a sophisticated city-beach combination at Dubai Marina.</p>
...
<p>Thank you for choosing <strong>{$brandName}</strong>. Your perfect beachfront stay awaits.</p>
HTML;
    }
...
<strong>Phone:</strong> +971 4 555 8899<br>
<strong>Address:</strong> Jumeirah Beach Road, Dubai, United Arab Emirates</p>
HTML;
    }
