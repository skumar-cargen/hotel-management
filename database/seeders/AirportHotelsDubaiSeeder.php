...
class AirportHotelsDubaiSeeder extends Seeder
{
    private int $counter = 700;

    public function run(): void
    {
        $this->command->info('Seeding Airport Hotels Dubai domain...');
        ...
        $this->command->info('Airport Hotels Dubai seeded successfully!');
    }
    ...
    private function seedDomain(): Domain
    {
        $domain = Domain::updateOrCreate(
            ['slug' => 'airport-hotels-dubai'],
            [
                'name' => 'Airport Hotels Dubai',
                'domain' => 'airporthotelsdubai.com',
                'is_active' => true,
                'is_primary' => false,
                'default_currency' => 'AED',
                'default_language' => 'en',
                'meta_title' => 'Airport Hotels Dubai — Hotels Near Dubai International Airport (DXB)',
                'meta_description' => 'Book hotels near Dubai International Airport. Convenient stays in Al Garhoud, Festival City, and Deira with free airport shuttle and early check-in options.',
                'meta_keywords' => 'airport hotels dubai, hotels near dxb, al garhoud hotels, festival city hotels, dubai airport hotel, transit hotel dubai',
                'phone' => '+971 4 282 4400',
                'email' => 'info@airporthotelsdubai.com',
                'address' => 'Al Garhoud, Near Dubai International Airport, Dubai, UAE',
            ]
        );
    ...
    private function seedHeroSlides(Domain $domain): void
    {
        ...
        $slides = [
            [
                'title' => 'Stay Near',
                'highlight' => 'Dubai Airport',
                'subtitle' => '5-star comfort minutes from DXB terminals',
                'description' => 'Seamless airport hotel stays with free shuttle services.',
                'keywords' => 'dubai,airport,hotel,modern',
            ],
            [
                'title' => 'Arrive Early',
                'highlight' => 'Depart Relaxed',
                'subtitle' => 'Early check-in and late check-out for your convenience',
                'description' => 'Flexible stays designed around your flight schedule.',
                'keywords' => 'hotel,room,luxury,business',
            ],
            [
                'title' => 'Discover',
                'highlight' => 'Al Garhoud & Festival City',
                'subtitle' => 'Dubai\'s best dining, shopping, and entertainment near the airport',
                'description' => 'More than just a stopover — explore vibrant airport-area neighborhoods.',
                'keywords' => 'dubai,creek,waterfront,night',
            ],
            [
                'title' => 'Business Meets',
                'highlight' => 'Convenience',
                'subtitle' => 'Conference facilities, business centres, and premium lounges',
                'description' => 'Purpose-built for business travellers and event delegates.',
                'keywords' => 'hotel,conference,business,modern',
            ],
        ];
    ...
    private function seedContentPages(Domain $domain): void
    {
        ...
        $domain->update([
            ...
            'about_us_meta_description' => "Learn about {$brandName} — your guide to the best hotels near Dubai International Airport. Discover our mission, values, and commitment to convenient hospitality.",
    ...
    private function generateLogoPng(string $path, string $brandName): void
    {
        ...
        $iconColor = imagecolorallocate($img, 50, 130, 200);
        $iconSize = 50;
        ...
        imagestring($img, 5, 75, 42, 'Airport Hotels', $textColor);
        $lightColor = imagecolorallocate($img, 120, 120, 140);
        imagestring($img, 4, 75, 60, 'Dubai', $lightColor);
    ...
    private function generateFaviconPng(string $path, string $brandName): void
    {
        ...
        // Sky blue background
        $bgColor = imagecolorallocate($img, 50, 130, 200);
        imagefilledrectangle($img, 4, 4, $size - 5, $size - 5, $bgColor);

        $white = imagecolorallocate($img, 255, 255, 255);
        $tw = imagefontwidth(5);
        $th = imagefontheight(5);
        imagestring($img, 5, ($size - $tw) / 2, ($size - $th) / 2, 'A', $white);
...
<p>At <strong>{$brandName}</strong>, we specialise in connecting travellers with the best hotels near Dubai International Airport (DXB). Whether you need a convenient stopover, a comfortable pre-flight stay, or a base to explore Dubai's vibrant airport-area neighbourhoods, we have the perfect hotel for you.</p>

<h3>Our Mission</h3>
<p>Our mission is to make booking an airport hotel in Dubai seamless and stress-free. We curate a collection of hotels — from luxury resorts in Al Garhoud to budget-friendly options in Al Rashidiya — ensuring every traveller finds the right stay at the right price.</p>

<h3>What Sets Us Apart</h3>
<ul>
    <li><strong>Airport Proximity Experts</strong> — Every hotel in our collection is within 15 minutes of Dubai International Airport terminals.</li>
    <li><strong>Shuttle Services</strong> — Most of our partner hotels offer complimentary airport shuttle services.</li>
    <li><strong>Flexible Check-In</strong> — We feature hotels with early check-in and late check-out options to match your flight schedule.</li>
    <li><strong>Business Ready</strong> — Conference facilities, business centres, and executive lounges for corporate travellers.</li>
    <li><strong>24/7 Support</strong> — Our dedicated team is available around the clock, because flights don't keep office hours.</li>
</ul>

<h3>Our Story</h3>
<p>{$brandName} was founded by a team of frequent travellers and hospitality professionals who understood the unique needs of airport hotel guests. We know that sometimes you need a quiet room for a few hours between flights, and other times you want a full resort experience within reach of the airport. Our curated collection caters to both.</p>
<p>Today we serve thousands of travellers passing through Dubai — from business executives attending conferences in Al Garhoud to families enjoying Festival City's waterfront attractions before their onward journey.</p>

<h3>Our Values</h3>
<ul>
    <li><strong>Convenience</strong> — Location and accessibility are at the heart of every hotel we list.</li>
    <li><strong>Transparency</strong> — No hidden fees, no misleading photos. What you see is what you get.</li>
    <li><strong>Flexibility</strong> — We understand that travel plans change, and our policies reflect that.</li>
    <li><strong>Quality</strong> — Every hotel is personally vetted to ensure it meets our standards.</li>
</ul>

<p>Thank you for choosing <strong>{$brandName}</strong>. Your seamless airport stay awaits.</p>
HTML;
    }
...
<strong>Phone:</strong> +971 4 282 4400<br>
<strong>Address:</strong> Al Garhoud, Near Dubai International Airport, Dubai, UAE</p>
HTML;
    }
