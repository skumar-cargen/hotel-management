...
class AjmanDiscountHotelsSeeder extends Seeder
{
    private int $counter = 1100;

    public function run(): void
    {
        $this->command->info('Seeding Ajman Discount Hotels domain...');
        ...
        $this->command->info('Ajman Discount Hotels seeded successfully!');
    }
    ...
    private function seedDomain(): Domain
    {
        $domain = Domain::updateOrCreate(
            ['slug' => 'ajman-discount-hotels'],
            [
                'name' => 'Ajman Discount Hotels',
                'domain' => 'ajmandiscounthotels.com',
                'is_active' => true,
                'is_primary' => false,
                'default_currency' => 'AED',
                'default_language' => 'en',
                'meta_title' => 'Ajman Discount Hotels — Affordable Beach Hotels in Ajman, UAE',
                'meta_description' => 'Book affordable beach hotels in Ajman, UAE. Five-star luxury at discount prices on Ajman Corniche. Beach resorts, family hotels, and budget stays.',
                'meta_keywords' => 'ajman hotels, discount hotels ajman, ajman beach hotels, ajman corniche hotels, cheap hotels uae, affordable beach resort ajman',
                'phone' => '+971 6 742 3300',
                'email' => 'info@ajmandiscounthotels.com',
                'address' => 'Ajman Corniche, Ajman, United Arab Emirates',
            ]
        );
    ...
    private function seedHeroSlides(Domain $domain): void
    {
        ...
        $slides = [
            [
                'title' => 'Discover',
                'highlight' => 'Ajman\'s Beach Paradise',
                'subtitle' => 'Five-star luxury at prices that will surprise you',
                'description' => 'Stunning beachfront hotels on Ajman Corniche at unbeatable rates.',
                'keywords' => 'beach,resort,sunset,sea',
            ],
            [
                'title' => 'Luxury For',
                'highlight' => 'Less',
                'subtitle' => 'Premium beach resorts from AED 250 per night',
                'description' => 'Why pay Dubai prices when Ajman offers the same Gulf views?',
                'keywords' => 'hotel,luxury,pool,resort',
            ],
            [
                'title' => 'Family',
                'highlight' => 'Beach Holidays',
                'subtitle' => 'Spacious rooms, kids clubs, and safe sandy beaches',
                'description' => 'The perfect affordable family getaway just 30 minutes from Dubai.',
                'keywords' => 'family,beach,holiday,happy',
            ],
            [
                'title' => 'Your Arabian Gulf',
                'highlight' => 'Escape',
                'subtitle' => 'Crystal waters, white sand, and warm Emirati hospitality',
                'description' => 'Ajman\'s pristine coastline is the UAE\'s best-kept secret.',
                'keywords' => 'gulf,sea,beach,calm',
            ],
        ];
    ...
    private function seedContentPages(Domain $domain): void
    {
        ...
        $domain->update([
            ...
            'about_us_meta_description' => "Learn about {$brandName} — your gateway to affordable luxury beach hotels in Ajman, UAE. Discover why Ajman is the smart traveller's choice.",
    ...
    private function generateLogoPng(string $path, string $brandName): void
    {
        ...
        // Ocean teal brand color
        $iconColor = imagecolorallocate($img, 0, 150, 136);
        $iconSize = 50;
        imagefilledrectangle($img, 10, 35, 10 + $iconSize, 35 + $iconSize, $iconColor);

        $white = imagecolorallocate($img, 255, 255, 255);
        $initials = 'AJ';
        imagestring($img, 5, 22, 52, $initials, $white);

        $textColor = imagecolorallocate($img, 30, 30, 50);
        imagestring($img, 5, 75, 42, 'Ajman Discount', $textColor);
...
<p>At <strong>{$brandName}</strong>, we believe luxury beach holidays shouldn't break the bank. We specialise in connecting travellers with premium beachfront hotels in Ajman — the UAE's best-kept secret for affordable luxury on the Arabian Gulf.</p>

<h3>Our Mission</h3>
<p>Our mission is simple: bring you five-star beach resort experiences at prices that make you smile. Ajman's stunning corniche offers the same crystal-clear Gulf waters and golden sands as Dubai — at a fraction of the price. We make discovering and booking these incredible value properties effortless.</p>

<h3>What Sets Us Apart</h3>
<ul>
    <li><strong>Value Experts</strong> — We negotiate exclusive discount rates with Ajman's best hotels, passing the savings directly to you.</li>
    <li><strong>Beach Specialists</strong> — Every property in our collection offers beach access or stunning Gulf views. We know Ajman's coastline inside out.</li>
    <li><strong>Family Focused</strong> — Safe beaches, kids clubs, and spacious family rooms — we specialise in affordable family getaways.</li>
    <li><strong>24/7 Support</strong> — Our dedicated team is available around the clock to ensure your stay is perfect.</li>
    <li><strong>Flexible Booking</strong> — Free cancellation on most properties up to 48 hours before check-in.</li>
</ul>

<h3>Our Story</h3>
<p>{$brandName} was born from a simple observation: travellers were paying premium prices in Dubai for the same Gulf views available in Ajman at 40–60% less. We set out to showcase Ajman's incredible beach hotels to a wider audience, proving that luxury and affordability can go hand in hand.</p>
<p>Today we serve thousands of happy guests each year — families seeking affordable beach holidays, couples looking for romantic Gulf-side escapes, and savvy travellers who know that the best value in the UAE lies just 30 minutes from Dubai.</p>

<h3>Our Values</h3>
<ul>
    <li><strong>Transparency</strong> — No hidden fees, no misleading photos. What you see is what you get.</li>
    <li><strong>Value</strong> — We are obsessed with getting you the best possible rate for every stay.</li>
    <li><strong>Guest-First</strong> — Every decision starts with: "Is this best for our guests?"</li>
    <li><strong>Community</strong> — We support Ajman's local hospitality industry and promote sustainable tourism.</li>
</ul>

<p>Thank you for choosing <strong>{$brandName}</strong>. Your affordable beach paradise awaits.</p>
HTML;
    }
...
<strong>Phone:</strong> +971 6 742 3300<br>
<strong>Address:</strong> Ajman Corniche, Ajman, United Arab Emirates</p>
HTML;
    }
...
<ul>
    ...
    <li>A tourism dirham fee (AED 7–20 per room per night, depending on property classification) is applied as per Ajman Tourism regulations</li>
...
<p>These Terms and Conditions are governed by the laws of the United Arab Emirates. Any disputes arising shall be subject to the exclusive jurisdiction of the courts of Ajman, UAE.</p>
