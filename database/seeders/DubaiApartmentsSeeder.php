...
class DubaiApartmentsSeeder extends Seeder
{
    private int $counter = 500;

    public function run(): void
    {
        $this->command->info('Seeding Dubai Apartments domain...');
        ...
        $this->command->info('Dubai Apartments seeded successfully!');
    }
    ...
    private function seedDomain(): Domain
    {
        $domain = Domain::updateOrCreate(
            ...
            [
                ...
                'domain' => 'dubaiapartments.com',
                'is_active' => true,
                'is_primary' => false,
                'default_currency' => 'AED',
                'default_language' => 'en',
                'meta_title' => 'Dubai Apartments — Serviced Apartments & Hotel Residences in Dubai',
                'meta_description' => 'Book premium serviced apartments and hotel residences across Dubai. Spacious living with hotel amenities in Business Bay, JLT, Sports City, and more.',
                'meta_keywords' => 'dubai apartments, serviced apartments dubai, hotel apartments dubai, furnished apartments dubai, long stay dubai, business bay apartments',
                'phone' => '+971 4 222 8800',
                'email' => 'info@dubaiapartments.com',
    ...
    private function seedHeroSlides(Domain $domain): void
    {
        ...
        $slides = [
            [
                'title' => 'Your Home In',
                'highlight' => 'The Heart of Dubai',
                'subtitle' => 'Spacious serviced apartments with hotel-grade amenities',
                'description' => 'Live the Dubai lifestyle in premium furnished apartments.',
                'keywords' => 'dubai,apartment,modern,luxury',
            ],
            [
                'title' => 'Experience',
                'highlight' => 'Space & Comfort',
                'subtitle' => 'Full kitchens, living areas, and stunning city views',
                'description' => 'More than a hotel room — a complete home away from home.',
                'keywords' => 'apartment,interior,modern,living',
            ],
            [
                'title' => 'Stay Longer',
                'highlight' => 'Pay Smarter',
                'subtitle' => 'Exclusive long-stay rates and flexible booking',
                'description' => 'Whether one week or one year, enjoy exceptional value.',
                'keywords' => 'dubai,skyline,night,city',
            ],
            [
                'title' => 'Live Like',
                'highlight' => 'A Local',
                'subtitle' => 'Neighborhoods with personality, culture, and convenience',
                'description' => 'Discover Dubai beyond the tourist trail from your own apartment.',
                'keywords' => 'dubai,lifestyle,city,modern',
            ],
        ];
    ...
    private function seedContentPages(Domain $domain): void
    {
        ...
        $domain->update([
            ...
            'about_us_meta_description' => "Learn about {$brandName} — your specialist in serviced apartments and hotel residences across Dubai. Discover our mission, values, and commitment to home-away-from-home hospitality.",
    ...
    private function generateLogoPng(string $path, string $brandName): void
    {
        ...
        // Warm copper brand color
        $iconColor = imagecolorallocate($img, 180, 120, 60);
        $iconSize = 50;
        imagefilledrectangle($img, 10, 35, 10 + $iconSize, 35 + $iconSize, $iconColor);

        $white = imagecolorallocate($img, 255, 255, 255);
        $initial = 'DA';
        imagestring($img, 5, 22, 52, $initial, $white);

        $textColor = imagecolorallocate($img, 30, 30, 50);
        imagestring($img, 5, 75, 42, 'Dubai', $textColor);
        $lightColor = imagecolorallocate($img, 120, 120, 140);
        imagestring($img, 4, 75, 60, 'Apartments', $lightColor);
...
<p>At <strong>{$brandName}</strong>, we specialise in connecting travellers and residents with the finest serviced apartments and hotel residences across Dubai. From the bustling energy of Business Bay to the lakeside charm of Jumeirah Lake Towers, we curate a collection of apartment-style accommodations that offer the space of a home with the service of a hotel.</p>

<h3>Our Mission</h3>
<p>Our mission is to make finding and booking the perfect serviced apartment in Dubai effortless. Whether you are visiting for a week, relocating for a project, or seeking a long-term home, we handpick every property to ensure it meets the highest standards of comfort, convenience, and value.</p>

<h3>What Sets Us Apart</h3>
<ul>
    <li><strong>Apartment Specialists</strong> — Every property in our collection offers genuine living space — full kitchens, separate living areas, and the comforts of home. We know Dubai's apartment landscape like no one else.</li>
    <li><strong>Extended Stay Experts</strong> — We negotiate exclusive long-stay rates and flexible lease terms that you won't find on generic booking platforms.</li>
    <li><strong>Local Expertise</strong> — Our Dubai-based team provides insider knowledge on the best neighbourhoods, community amenities, and seasonal offers.</li>
    <li><strong>24/7 Concierge</strong> — From airport transfers to grocery delivery, our dedicated team is available around the clock to make your stay seamless.</li>
    <li><strong>Flexible Booking</strong> — Free cancellation on most properties up to 48 hours before check-in, with flexible month-to-month options for extended stays.</li>
</ul>

<h3>Our Story</h3>
<p>Born from the understanding that travellers and professionals need more than just a hotel room, {$brandName} was founded by a team of hospitality professionals and real estate experts who saw an opportunity to bridge the gap between short-term hotels and long-term rentals. We believe that where you live shapes your entire experience — and a well-appointed apartment in the right neighbourhood transforms a trip into a lifestyle.</p>
<p>Today we serve thousands of guests each year, helping them discover the perfect apartment-style stay — whether it is a studio in the tech hub of Dubai Silicon Oasis, a family-sized apartment in Sports City, or a premium serviced residence overlooking the Business Bay canal.</p>

<h3>Our Values</h3>
<ul>
    <li><strong>Transparency</strong> — No hidden fees, no misleading photos. What you see is what you get.</li>
    <li><strong>Space & Comfort</strong> — We never compromise on living space or apartment quality.</li>
    <li><strong>Guest-First</strong> — Every decision starts with: "Is this best for our guests?"</li>
    <li><strong>Community</strong> — We partner with properties that foster genuine neighbourhood living and local experiences.</li>
</ul>

<p>Thank you for choosing <strong>{$brandName}</strong>. Your perfect apartment stay awaits.</p>
HTML;
    }
...
<strong>Phone:</strong> +971 4 222 8800<br>
<strong>Address:</strong> Business Bay, Bay Square, Dubai, UAE</p>
HTML;
    }
