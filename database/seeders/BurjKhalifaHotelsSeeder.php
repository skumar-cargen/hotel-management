...
class BurjKhalifaHotelsSeeder extends Seeder
{
    private int $counter = 400;

    public function run(): void
    {
        $this->command->info('Seeding Burj Khalifa Hotels domain...');
        ...
        $this->command->info('Burj Khalifa Hotels seeded successfully!');
    }
    ...
    private function seedDomain(): Domain
    {
        $domain = Domain::updateOrCreate(
            ['slug' => 'burjkhalifahotelsonline'],
            [
                'name' => 'Burj Khalifa Hotels',
                'domain' => 'burjkhalifahotelsonline.com',
                'is_active' => true,
                'is_primary' => false,
                'default_currency' => 'AED',
                'default_language' => 'en',
                'meta_title' => 'Burj Khalifa Hotels — Luxury Hotels in Downtown Dubai',
                'meta_description' => 'Discover and book luxury hotels in Downtown Dubai near Burj Khalifa and Dubai Mall. Premium stays with stunning skyline views, world-class dining, and iconic attractions.',
                'meta_keywords' => 'downtown dubai hotels, burj khalifa hotels, dubai mall hotels, business bay hotels, difc hotels, dubai accommodation, luxury dubai hotels',
                'phone' => '+971 4 555 8800',
                'email' => 'info@burjkhalifahotelsonline.com',
                'address' => 'Downtown Dubai, Near Burj Khalifa, Dubai, UAE',
            ]
        );
    ...
    private function seedHeroSlides(Domain $domain): void
    {
        ...
        $slides = [
            [
                'title' => 'Experience',
                'highlight' => 'Downtown Dubai Luxury',
                'subtitle' => 'Handpicked hotels in the shadow of the world\'s tallest tower',
                'description' => 'Book luxury hotels in Downtown Dubai — steps from Burj Khalifa, Dubai Mall, and Dubai Fountain.',
                'keywords' => 'dubai,burj-khalifa,luxury,skyline',
            ],
            [
                'title' => 'Discover',
                'highlight' => 'The Dubai Mall District',
                'subtitle' => 'Stay steps from 1,200+ shops, the aquarium, and Dubai Fountain',
                'description' => 'Premium hotels within walking distance of the world\'s largest shopping destination.',
                'keywords' => 'dubai,mall,shopping,modern',
            ],
            [
                'title' => 'Iconic Views',
                'highlight' => 'Burj Khalifa & Beyond',
                'subtitle' => 'Wake up to the world\'s most spectacular skyline every morning',
                'description' => 'Hotels with breathtaking views of the world\'s tallest tower and the Downtown Dubai skyline.',
                'keywords' => 'dubai,skyline,sunset,tower',
            ],
            [
                'title' => 'Your Gateway To',
                'highlight' => 'DIFC & Business Bay',
                'subtitle' => 'Premium hotels for discerning business and leisure travellers',
                'description' => 'Strategically located hotels perfect for executives, investors, and travellers exploring Dubai.',
                'keywords' => 'dubai,business,financial,modern',
            ],
        ];
    ...
    private function seedContentPages(Domain $domain): void
    {
        ...
        $domain->update([
            ...
            'about_us_meta_description' => "Learn about {$brandName} — your guide to luxury hotels in the Downtown Dubai district. Discover our mission, values, and commitment to hospitality excellence.",
    ...
    private function generateLogoPng(string $path, string $brandName): void
    {
        ...
        // Gold brand color
        $iconColor = imagecolorallocate($img, 212, 175, 55);
        $iconSize = 50;
        imagefilledrectangle($img, 10, 35, 10 + $iconSize, 35 + $iconSize, $iconColor);

        $white = imagecolorallocate($img, 255, 255, 255);
        imagestring($img, 5, 22, 52, 'BK', $white);

        $textColor = imagecolorallocate($img, 30, 30, 50);
        imagestring($img, 5, 75, 42, 'Burj Khalifa', $textColor);
...
<p>At <strong>{$brandName}</strong>, we specialise in connecting travellers with the finest luxury hotels in Dubai's iconic Downtown district. From the awe-inspiring Burj Khalifa and the world-famous Dubai Mall to the vibrant waterfront of Business Bay and the prestigious Dubai International Financial Centre (DIFC), we curate a collection of hotels that combine luxury, location, and unforgettable experiences.</p>

<h3>Our Mission</h3>
<p>Our mission is to make finding and booking the perfect hotel near Dubai's most iconic landmarks effortless. We handpick every property to ensure it meets the highest standards of luxury, location, and guest satisfaction — whether you're visiting for business, leisure, or a special celebration.</p>

<h3>What Sets Us Apart</h3>
<ul>
    <li><strong>Downtown Specialists</strong> — We know every tower, every boulevard, and every hidden gem in the Downtown Dubai district. Our local expertise is unmatched.</li>
    <li><strong>Best Price Guarantee</strong> — We work directly with hotels to offer rates you won't find on generic booking platforms.</li>
    <li><strong>Skyline Views</strong> — Every hotel we feature offers stunning views of Burj Khalifa, Dubai Fountain, or the glittering Downtown skyline.</li>
    <li><strong>24/7 Support</strong> — Our Dubai-based team is available around the clock to assist with bookings, changes, and special requests.</li>
    <li><strong>Flexible Booking</strong> — Free cancellation on most properties up to 48 hours before check-in.</li>
</ul>

<h3>Our Story</h3>
<p>Downtown Dubai has undergone one of the most remarkable transformations in modern history — from open desert to the world's most recognizable skyline in just two decades. Home to the tallest building on Earth, the largest shopping mall, and the most-watched fountain show, Downtown Dubai is where ambition meets reality. {$brandName} was founded to showcase the best hotels in this extraordinary neighbourhood — helping travellers experience the magic of Dubai's crown jewel.</p>
<p>Today we serve thousands of guests each year, from business executives attending conferences at DIFC, to families exploring Dubai Mall's aquarium and ice rink, to couples seeking a romantic evening watching the Dubai Fountain from their balcony.</p>

<h3>Our Values</h3>
<ul>
    <li><strong>Transparency</strong> — No hidden fees, no misleading descriptions. Honest information about every property.</li>
    <li><strong>Quality</strong> — We personally inspect and review every hotel in our collection.</li>
    <li><strong>Guest-First</strong> — Every decision we make starts with: "Is this best for our guests?"</li>
    <li><strong>Community</strong> — We support local businesses and promote the Downtown Dubai community.</li>
</ul>

<p>Thank you for choosing <strong>{$brandName}</strong>. Your perfect Downtown Dubai stay awaits.</p>
HTML;
    }
...
<strong>Phone:</strong> +971 4 555 8800<br>
<strong>Address:</strong> Downtown Dubai, Near Burj Khalifa, Dubai, UAE</p>
HTML;
    }
