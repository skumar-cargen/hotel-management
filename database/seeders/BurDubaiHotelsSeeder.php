...
class BurDubaiHotelsSeeder extends Seeder
{
    private int $counter = 900;

    public function run(): void
    {
        $this->command->info('Seeding Bur Dubai Hotels domain...');
        ...
        $this->command->info('Bur Dubai Hotels seeded successfully!');
    }
    ...
    private function seedDomain(): Domain
    {
        $domain = Domain::updateOrCreate(
            ['slug' => 'bur-dubai-hotels'],
            [
                'name' => 'Bur Dubai Hotels',
                'domain' => 'burdubaihotels.com',
                'is_active' => true,
                'is_primary' => false,
                'default_currency' => 'AED',
                'default_language' => 'en',
                'meta_title' => 'Bur Dubai Hotels — Heritage Hotels & Stays in Old Dubai',
                'meta_description' => 'Book hotels in Bur Dubai, Dubai\'s historic heart. From heritage boutique hotels in Al Fahidi to five-star landmarks in Oud Metha, discover authentic old Dubai charm.',
                'meta_keywords' => 'bur dubai hotels, old dubai hotels, al fahidi hotels, meena bazaar hotels, oud metha hotels, heritage hotels dubai, karama hotels',
                'phone' => '+971 4 353 6600',
                'email' => 'info@burdubaihotels.com',
                'address' => 'Al Fahidi Historical Neighbourhood, Bur Dubai, Dubai, UAE',
            ]
        );
    ...
    private function seedHeroSlides(Domain $domain): void
    {
        ...
        $slides = [
            [
                'title' => 'Discover',
                'highlight' => 'Historic Bur Dubai',
                'subtitle' => 'Where Dubai\'s heritage meets modern hospitality',
                'description' => 'Explore the soul of old Dubai from charming heritage hotels.',
                'keywords' => 'dubai,historic,heritage,culture',
            ],
            [
                'title' => 'Stay In',
                'highlight' => 'Dubai\'s Cultural Heart',
                'subtitle' => 'Al Fahidi, Creek, souks & museums at your doorstep',
                'description' => 'Immerse yourself in authentic Arabian culture and history.',
                'keywords' => 'arabic,architecture,traditional,souk',
            ],
            [
                'title' => 'Experience',
                'highlight' => 'Old World Charm',
                'subtitle' => 'Heritage courtyard hotels and modern luxury landmarks',
                'description' => 'From boutique art hotels to grand five-star landmarks.',
                'keywords' => 'hotel,heritage,courtyard,elegant',
            ],
            [
                'title' => 'Explore',
                'highlight' => 'The Real Dubai',
                'subtitle' => 'Textile souks, Creek abra rides & authentic street food',
                'description' => 'The Dubai that locals love — vibrant, authentic, and unforgettable.',
                'keywords' => 'dubai,creek,boat,traditional',
            ],
        ];
    ...
    private function seedContentPages(Domain $domain): void
    {
        ...
        $domain->update([
            ...
            'about_us_meta_description' => "Learn about {$brandName} — your guide to heritage hotels and authentic stays in Dubai's historic heart, from Al Fahidi to Oud Metha.",
    ...
    private function generateLogoPng(string $path, string $brandName): void
    {
        ...
        // Warm terracotta brand color
        $iconColor = imagecolorallocate($img, 180, 100, 60);
        $iconSize = 50;
        ...
        imagestring($img, 5, 75, 42, 'Bur Dubai', $textColor);
    ...
    private function generateFaviconPng(string $path, string $brandName): void
    {
        ...
        $bgColor = imagecolorallocate($img, 180, 100, 60);
        imagefilledrectangle($img, 4, 4, $size - 5, $size - 5, $bgColor);

        $white = imagecolorallocate($img, 255, 255, 255);
        $tw = imagefontwidth(5);
        $th = imagefontheight(5);
        imagestring($img, 5, ($size - $tw) / 2, ($size - $th) / 2, 'B', $white);
...
<p>At <strong>{$brandName}</strong>, we specialise in connecting travellers with the most characterful and authentic hotels in Dubai's historic heart. From the beautifully restored wind-tower houses of Al Fahidi to grand five-star landmarks in Oud Metha, we curate a collection of stays that let you experience the real Dubai — a city of heritage, culture, and warm Arabian hospitality.</p>

<h3>Our Mission</h3>
<p>Our mission is to showcase the soul of old Dubai through its hotels. We believe that where you stay shapes your experience, and a stay in Bur Dubai puts you at the crossroads of history, culture, and authentic local life — the Dubai that existed long before the skyscrapers.</p>

<h3>What Sets Us Apart</h3>
<ul>
    <li><strong>Heritage Specialists</strong> — We know Bur Dubai like no one else. From Al Fahidi's art scene to Meena Bazaar's textile heritage, our hotels put you in the heart of authentic Dubai.</li>
    ...
    <li><strong>Local Expertise</strong> — Our Dubai-based team provides insider knowledge on heritage walks, Creek crossings, souk tours, and hidden culinary gems.</li>
    <li><strong>24/7 Concierge</strong> — From airport transfers to traditional dhow dinner cruises, our dedicated team is available around the clock.</li>
    <li><strong>Flexible Booking</strong> — Free cancellation on most properties up to 48 hours before check-in.</li>
</ul>

<h3>Our Story</h3>
<p>Born from a passion for Dubai's rich cultural heritage, {$brandName} was founded by a team of hospitality professionals who saw that modern Dubai was overshadowing the historic charm that makes this city truly special. Bur Dubai is where it all began — the Creek, the souks, the Al Fahidi Fort (now the Dubai Museum), and the vibrant multicultural communities that give this area its unique character.</p>
<p>Today we serve thousands of guests each year, helping them discover the authentic Dubai — whether it's a boutique art hotel in a restored heritage house, a bustling four-star near the textile souks, or a sprawling five-star resort connected to the legendary Wafi Mall.</p>

<h3>Our Values</h3>
<ul>
    <li><strong>Authenticity</strong> — We celebrate real Dubai, its heritage, and its diverse communities.</li>
    ...
    <li><strong>Cultural Preservation</strong> — We support hotels that preserve and promote Dubai's architectural and cultural heritage.</li>
</ul>

<p>Thank you for choosing <strong>{$brandName}</strong>. Your authentic Dubai experience awaits.</p>
HTML;
    }
...
<strong>Phone:</strong> +971 4 353 6600<br>
<strong>Address:</strong> Al Fahidi Historical Neighbourhood, Bur Dubai, Dubai, UAE</p>
HTML;
    }
